...
$villa = $_GET['villa'];
  ...
  if ($villa == 'link1') {
        echo "<h1>Content for Link 1</h1>";
        // Display content specific to Link 1
    }
?>
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img class="display-4 m-5" height="450vw" width="93.5%" src="assets/img/villa1-3.jpg" alt="Third slide">
        </div>
        <div class="carousel-item">
            <img class="display-4 m-5" height="450vw" width="93.5%" src="assets/img/villa1-4.jpg" alt="Third slide">
        </div>
    </div>
...
<div class="text-box">
    ...
    <ul data-gtm-vis-recent-on-screen-1273266_1190="778" data-gtm-vis-first-on-screen-1273266_1190="778"
        ...
        class="kenmerken-highlighted__list fd-flex fd-list--none fd-p-none">
                    ...
                    viewBox="0 0 48 48">
                        <path
                            d="M38.5 32.25v-16.5a5 5 0 10-6.25-6.25h-16.5a5 5 0 10-6.25 6.25v16.5a5 5 0 106.25 6.25h16.5a5 5 0 106.25-6.25zm-6.25 3.25h-16.5a5 5 0 00-3.25-3.25v-16.5a5 5 0 003.25-3.25h16.5a5 5 0 003.25 3.25v16.5a5 5 0 00-3.25 3.25zM37 9a2 2 0 11-2 2 2 2 0 012-2zM11 9a2 2 0 11-2 2 2 2 0 012-2zm0 30a2 2 0 112-2 2 2 0 01-2 2zm26 0a2 2 0 112-2 2 2 0 01-2 2z">
                                        ...
                                        class="kenmerken-highlighted__value fd-text--nowrap">190 m²</span> <span
                    ...
                    viewBox="0 0 48 48">
                        <path
                            d="M43 5.5A1.5 1.5 0 0041.5 4h-35A1.5 1.5 0 005 5.5v37A1.5 1.5 0 006.5 44h35a1.5 1.5 0 001.5-1.5zm-35 9h13v5a1.5 1.5 0 001.5 1.5H30v20H8zm25 5a1.5 1.5 0 00-1.5-1.5H24v-5a1.5 1.5 0 00-1.5-1.5H8V7h32v34h-7z">
                                        ...
                                        class="kenmerken-highlighted__value fd-text--nowrap">760 m²</span> <span
                data-test-kenmerken-highlighted-description=""
