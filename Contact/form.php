...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <a class="navbar-brand" href="../homepage.html">Villa Sales</a>
...
<div class="container mt-5">
    <h3 class="text-center">Neem contact met ons</h3>
    <p class="text-center">Heeft u vragen? Stel ze gerust hier en wij kunnen u beantwoorden!</p>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form method="POST" action="process.php">
                ...
                <div class="text-end">
                <button type="submit" class="btn btn-transparent btn-outline-light-blue text-light-blue">Submit</button>
                </div>
            </form>
        </div>
    </div>
